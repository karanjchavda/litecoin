...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 10 * 30; // 2.5
        ...
        vSeeds.emplace_back("64.52.86.115", true);
        vSeeds.emplace_back("64.52.86.184", true);
        vSeeds.emplace_back("165.227.237.144", true);
